...
For VSD compressors, the CAGI datasheet doesn't always report isentropic efficiency. When it does, it reports it at a single test point, which may not represent the typical operating point. Use this mini-calculator to back-calculate isentropic efficiency from measured specific power data.
...
(function() {
    ...
    function calcVsdEff() {
        ...
        resultDiv.innerHTML = `
            ...
            ${note}
            <p style="margin: 10px 0 0 0; font-size: 0.85em; color: var(--md-default-fg-color--light);">Use the efficiency value above as the "Isentropic Eff." input in the cold air intake calculator below.</p>`;
    }
